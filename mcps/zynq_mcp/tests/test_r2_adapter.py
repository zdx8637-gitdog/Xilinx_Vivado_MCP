            ...
            async def _r():
                async with stdio_client(params) as(r,w):
                    async with ClientSession(r,w) as s:
                        ...
                        assert caps["status"]=="success" and caps["data"]["total_tools"]==104  # B11 ③.1: 100 (phase 2, platform_generate removed) + assign_addresses/make_external/synthesize = 103 (9 control + 94 domain); B12-N3 + ps_start_hw_server = 104 (9 control + 95 domain)
