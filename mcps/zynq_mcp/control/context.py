...
# B13-F3 修复轮#7: PL_GENERATE 无平台级回退目标——白盒 r2 在 export_manifest
# 之后需改 BD（add_ps7/connect 等平台原子全部 STAGE_PREREQUISITE_UNMET），
# 被迫 close+create 三次。平台级迭代必须合法：所有 PL_GENERATE 之后的阶段
# 都允许回 PLATFORM_DESIGN（改 BD）与 PL_BUILD（重综合）。
ROLLBACK_TARGETS = {
    STAGE_PL_GENERATE: [STAGE_PLATFORM_DESIGN],
    STAGE_PL_BUILD: [STAGE_PLATFORM_DESIGN, STAGE_PL_BUILD],
    STAGE_PL_TIMING: [STAGE_PL_BUILD, STAGE_PLATFORM_DESIGN],
    STAGE_PL_BITSTREAM: [STAGE_PL_BUILD, STAGE_PLATFORM_DESIGN],
    STAGE_PL_IMPLEMENT: [STAGE_PL_BUILD, STAGE_PLATFORM_DESIGN],
    STAGE_PS_BUILD: [STAGE_PL_BUILD, STAGE_PLATFORM_DESIGN, STAGE_PS_BUILD],
    STAGE_CONSISTENCY_CHECK: [STAGE_PL_BUILD, STAGE_PLATFORM_DESIGN,
                              STAGE_PS_BUILD],
